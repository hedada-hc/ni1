...
0
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/default/common/header_common.htm', 1500615501, '3', './data/template/2_3_common_header_forum_viewthread.tpl.php', './template/comiis_nby', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/comiis_user.htm', 1500615501, '3', './data/template/2_3_common_header_forum_viewthread.tpl.php', './template/comiis_nby', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/comiis_navss.htm', 1500615501, '3', './data/template/2_3_common_header_forum_viewthread.tpl.php', './template/comiis_nby', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/comiis_nby/common/header_qmenu.htm', 1500615501, '3', './data/template/2_3_common_header_forum_viewthread.tpl.php', './template/comiis_nby', 'common/header_forum_viewthread')
|| checktplrefresh('./template/comiis_nby/common/header.htm', './template/default/common/pubsearchform.htm', 1500615501, '3', './data/template/2_3_common_header_forum_viewthread.tpl.php', './template/comiis_nby', 'common/header_forum_viewthread')
;?>
...
<a class="comiis_tkefu" target="_blank" href="#" title="在线客服"></a><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
...
<?php } if($comiis_navss==1 && $_G['setting']['search'] && $slist) { ?>
